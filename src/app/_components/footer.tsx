...
export function Footer() {
  return (
    <footer className="w-full text-gray-700 bgcolor body-font" style={{ backgroundColor: '#111827' }}>
    <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            <a className="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
                        </a>
            <p className="mt-2 text-sm text-gray-500">Sentinel 360</p>
            <div className="mt-4">
        ...
        <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                <h2 className="mb-3 text-sm font-medium tracking-widest  uppercase title-font text-gray-100">About</h2>
                <nav className="mb-10 list-none">
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white">Company</a>
                    </li>
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white">Services</a>
                    </li>
                    <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-white">Team</a>
                    </li>
                </nav>
            </div>
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                <h2 className="mb-3 text-sm font-medium tracking-widest  uppercase title-font text-gray-100">Support</h2>
                <nav className="mb-10 list-none">
                    <li className="mt-3">
            ...
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                <h2 className="mb-3 text-sm font-medium tracking-widest  uppercase title-font text-gray-100">Platform
                </h2>
                <nav className="mb-10 list-none">
                    <li className="mt-3">
            ...
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                <h2 className="mb-3 text-sm font-medium tracking-widest  uppercase text-gray-100 title-font">Contact</h2>
                <nav className="mb-10 list-none">
                    <li className="mt-3">
