...
<nav className="bg-white border-gray-200 pt-2 pb-2 px-4 lg:px-6 py-2.5 ">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="/" className="flex items-center">
              ...
              <img src={'assets/blog/logo.svg'} style={{height: "38px"}} alt="" />
                ...
                <span className="self-center text-xl font-semibold whitespace-nowrap ">Sentinel360</span>
            </a>
            <div className="flex items-center lg:order-2">
             
                <a href="#" className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2   focus:outline-none  btncolor">Get started</a>
